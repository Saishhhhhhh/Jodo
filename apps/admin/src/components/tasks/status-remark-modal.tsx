      ...
      <SheetContent side="right" className="w-full sm:max-w-lg overflow-y-auto bg-card border-l border-border">
        <SheetHeader className="mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <SheetTitle className="text-xl font-bold">Update Task Status & Remark</SheetTitle>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 py-2">
          ...
          {showHistory && task.remarks && task.remarks.length > 0 && (
            <div className="p-3.5 rounded-lg border border-border bg-muted/30 space-y-2.5 max-h-56 overflow-y-auto">
          ...
          <SheetFooter className="pt-4 border-t border-border flex gap-3">
            <Button
              type="button"
              variant="outline"
              className="flex-1"
