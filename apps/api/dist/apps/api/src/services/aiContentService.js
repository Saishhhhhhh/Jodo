...
class AiContentService {
     ...
     */
    static async regenerate(currentContent, input, instruction) {
        const toneModifier = instruction.toLowerCase().includes('premium')
            ...
            : instruction.toLowerCase().includes('professional')
                ...
                : instruction.toLowerCase().includes('engaging')
                    ? 'Engaging & Vibrant'
                    : input.tone || 'Luxury';
        const lengthModifier = instruction
            .toLowerCase()
            .includes('shorter')
            ? 'Short'
    ...
    // -------------------------------------------------------------
    static generateProductDescription(input, tone, length) {
    ...
    static generateCatalogueContent(input, tone, length) {
    ...
    static generateListingCopy(input, tone, length) {
    ...
    static generateCampaignContent(input, tone) {
