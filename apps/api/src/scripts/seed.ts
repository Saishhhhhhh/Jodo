...
async function seedDummyData(tenantId: any, storeId: any) {
  ...
  const products = await Product.insertMany([
    ...
    { tenantId: tenantId, storeId: storeId, title: 'Organic Arabica Coffee Beans', slug: 'coffee-beans', status: 'active', price: 18.00, sku: 'CB-004', inventoryQuantity: 300, category: 'Food & Beverage', vendor: 'Jodo Farms', imageUrl: 'https://images.unsplash.com/photo-1559056191-491a74e45c98?w=120&auto=format&fit=crop&q=60' },
    { tenantId: tenantId, storeId: storeId, title: 'Minimalist Leather Wallet', slug: 'leather-wallet', status: 'draft', price: 45.00, sku: 'LW-005', inventoryQuantity: 0, category: 'Accessories', vendor: 'Jodo Leather', imageUrl: 'https://images.unsplash.com/photo-1627124357773-41319d8e841f?w=120&auto=format&fit=crop&q=60' },
  ]);
