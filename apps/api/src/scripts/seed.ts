...
async function seedDummyData(tenantId: any, storeId: any) {
  ...
  const products = await Product.insertMany([
    { tenantId: tenantId, storeId: storeId, title: 'Premium Cotton T-Shirt', slug: 'cotton-tshirt', status: 'active', price: 29.99, compareAtPrice: 39.99, sku: 'TSH-001', inventoryQuantity: 150, category: 'Apparel' },
    { tenantId: tenantId, storeId: storeId, title: 'Wireless Noise-Canceling Headphones', slug: 'wireless-headphones', status: 'active', price: 199.99, compareAtPrice: 249.99, sku: 'WH-002', inventoryQuantity: 45, category: 'Electronics' },
    { tenantId: tenantId, storeId: storeId, title: 'Ergonomic Office Chair', slug: 'office-chair', status: 'active', price: 149.50, sku: 'OC-003', inventoryQuantity: 12, category: 'Furniture' },
    { tenantId: tenantId, storeId: storeId, title: 'Organic Arabica Coffee Beans', slug: 'coffee-beans', status: 'active', price: 18.00, sku: 'CB-004', inventoryQuantity: 300, category: 'Food & Beverage' },
    { tenantId: tenantId, storeId: storeId, title: 'Minimalist Leather Wallet', slug: 'leather-wallet', status: 'draft', price: 45.00, sku: 'LW-005', inventoryQuantity: 0, category: 'Accessories' },
  ]);
